Attribute VB_Name = "sw14_func_create_A1"
    
'工程图模板所在路径
Const strFormatePath As String = _
"C:\ProgramData\SOLIDWORKS\SOLIDWORKS 2019\lang\english\sheetformat\A1.drwdot"
'BOM的模板
...
'    Dim swApp As SldWorks.SldWorks
    ...
    dblPaperA1Length = 0.594
    dblPaperA1Width = 0.84
    Dim strTemplatePath As String
    strTemplatePath = swApp.GetUserPreferenceStringValue(swUserPreferenceStringValue_e.swDefaultTemplateDrawing)
    Set swModel = swApp.NewDocument(strFormatePath, swDwgPapersUserDefined, dblPaperA1Width, dblPaperA1Length)
    '}
    
    Set swDraw = swModel
    
    'Setup first sheet
    swDraw.SetupSheet5 "Sheet1", 10, 10, 1, 5, True, strTemplatePath, dblPaperA1Width, dblPaperA1Length, "Default", True
...
'    swDraw.NewSheet3 "Sheet1", 12, 12, 1, 4, False, strFormatePath, dblPaperA1Width, dblPaperA1Length, "Default"
    ...
    Set swView = swDraw.CreateDrawViewFromModelView3(strModelPath, "*Isometric", 0.7, 0.45, 0)
